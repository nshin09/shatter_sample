        ...
        case state_v is
          ...
          when WAIT_FOR_HOST_RW =>  -- Wait for the host to read or write a block of data from the SD card.
            ...
            if rd_i = YES then  -- send READ command and address to the SD card.
              ...
              if continue_i = YES then  -- Multi-block read. Use stored address.
                ...
                elsif reverse = YES then                   -- SDHC cards use block-addressing,
                  addr_v := addr_v - 1;
                else
          ...
          when RD_BLK =>          -- Read a block of data from the SD card.
            ...
            if reverse = YES then
                ...
                elsif byteCnt_v >= 3 and byteCnt_v < (RD_BLK_SZ_C - 2) then  -- Now bytes of data from the SD card are received.
                  rtnData_v := true;        -- Return this data to the host.
                  byteCnt_v := byteCnt_v + 1;
                elsif byteCnt_v = RD_BLK_SZ_C - 2 then
                    rtnData_v := true;
                    byteCnt_v := 2;
